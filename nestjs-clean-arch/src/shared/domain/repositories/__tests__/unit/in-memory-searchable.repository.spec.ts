...
describe('InMemoryRepository unit tests', () => {
  ...
  describe('applyFilter method unit tests', () => {
  ...
  describe('applySort method unit tests', () => {
  ...
  describe('applyPaginate method unit tests', () => {
  ...
  describe('search method unit tests', () => {
    it('should only apply pagination when the other params are null', async () => {
